   ...
   <div class="row">
     ...
     <div class="col-12 col-xl-9 checkout-left">
       ...
       <div class="alert alert-danger alert-dismissible" id="paymentError" role="alert" style="display:none;">
           ...
           <h3 style="display:none" id="paymentErrorMessage" color="#ffffff"> Payment Failed </h3>
                                           ...
                                           @endforeach
                                                   ...
                                                   <?php
                                                      ...
                                                      // dd($price,$tax_rate,$shipping_price);
                                                       ...
                                                       echo htmlspecialchars($total_price); 
                                           ...
                                           <div class="modal-dialog">
                                               ...
                                               <div class="container-lg">
                                                   <div class="cell example example2">
                                                       ...
                                                       <button onclick="wipay()">@lang('website.Pay') {{$web_setting[19]->value}}{{number_format((float)$total_price+0, 2, '.', '')}}</button>
...
jQuery(document).on('click', '#cash_on_delivery_button, #banktransfer_button', function(e){    
        ...
        parameters.append('response_url','https://bradleyemanuels.com/checkout');
        parameters.append('total', dataphp);
        var options = {
        method: 'POST',
        headers: headers,
        body: parameters,
